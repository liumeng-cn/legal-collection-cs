  ...
  <el-container class="chat-layout">
    <el-aside width="260px" class="chat-aside">
      <div class="aside-header">
        <el-button type="primary" size="small" @click="newChat">新建会话</el-button>
      </div>
      <el-scrollbar class="conversation-list">
        ...
        <div v-if="!conversations.length" class="empty-tip">暂无历史会话</div>
      </el-scrollbar>
    </el-aside>
...
import { listConversations, listMessages, streamChat } from '../api/chat'
